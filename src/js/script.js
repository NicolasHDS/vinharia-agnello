var nomedovinho = prompt("Digite o nome do vinho: ");
var tipodovinho = prompt("Digite o tipo do vinho: ");
var safradovinho = prompt("Digite a safra do vinho: ");
var qtdestoque = prompt("Digite a quantidade em estoque: ");
